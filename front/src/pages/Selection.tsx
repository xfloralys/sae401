         ...
         <main className="container mx-auto px-8 min-h-[calc(100vh-140px)] flex justify-center items-center">
            <section className="">
               ...
               <div className="w-full flex flex-col justify-center items-center gap-2">
                  <NavLink to="/entrainement" className="btn-primary">Entrainement</NavLink>

                  <NavLink to="/classique" className="btn-primary">Classique</NavLink>

                  <NavLink to="/challenge" className="btn-primary">Challenge</NavLink>
               </div>
            </section>
         </main>
         <Footer />
